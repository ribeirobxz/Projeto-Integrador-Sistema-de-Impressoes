...
namespace WinFormsApp1.ModelView
{
    public class VisualizarHistorico : Historicos
    {
        ...
        public override string ToString()
        {
            ...
            return "Data: " + DataHistorico.ToString("dd/MM/yyyy") + " Tipo de movimentação: " + NomeTipoMovimentacoes + ", Quantidade total: " + QntdTotal + ", Saldo antes: " + SaldoAntes.ToString("F2") + ", Saldo depois: " + SaldoDepois.ToString("F2") + (ValorTotalPago.HasValue ? ", Valor total pago: R$ " + ValorTotalPago.Value.ToString("F2") : "");
        }
    }
}
